...
public class DonationPage {
    ...
    public static Target TRANSACTION_FREE_CHECKBOX = Target.the("error message").locatedBy("//*[@id=\"actual-form\"]/fieldset[2]/div[3]/div/label/span");
    ...
    public static Question<String> selectedAmount() {
        return Text.of(By.id("selected-amount"));
    }
    ...
    public static Question<String> selectedCountry() {
        return Text.of(By.id("country-confirm-name"));
    }
